...
const AdminMenu = () => {
  ...
  return (
    <>
       <div id="hamburger" onClick={bar} class="hidden  mx-4 my-3  cursor-pointer z-50" >
            <i class="fa-solid fa-bars fa-lg"></i>
        </div>
    <div id='barmenu' className='fixed flex flex-col  bg-blue-500 lg:w-[10%] md:w-[20%] sm:w-[30%]  items-center z-50'>
...
<a href='/ManageProducts' className='flex flex-col justify-center items-center'>
    <div className="size-14 mt-6">
        <img src={ProductImage} alt="Product" />
    </div> 
        <div href='/ManageProducts'className="textcenter">Manage Products</div>
</a>      
<a href='/ManageOrders' className='flex flex-col justify-center items-center mb-[50vh]'> 
    <div className="size-10 mt-6">
        <img src={OrderImage} alt="Order" />
    </div> 
        <div href='/ManageOrders' className="textcenter">Orders</div>
</a>
    </div>
    </>
