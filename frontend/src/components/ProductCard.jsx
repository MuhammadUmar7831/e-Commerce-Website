...
export default function ProductCard(props) {
  return (
    <div class="bg-white rounded-lg overflow-hidden shadow-lg shadow-gray-600 hover:shadow-xl hover:shadow-gray-600 hover:cursor-pointer transition-shadow w-full xs:w-[48%] md:w-1/3 lg:w-1/4 mx-2">
      <div class="relative">
        <img
      ...
      <div class="p-4">
        ...
        <div class="flex items-center justify-between">
          <span class="font-bold text-lg">{props.price}</span>
